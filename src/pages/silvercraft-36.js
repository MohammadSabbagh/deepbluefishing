...
const img1 = '../assets/media/boats/silvercraft_36/1.jpg'
const img2 = '../assets/media/boats/silvercraft_36/2.jpg'
const img3 = '../assets/media/boats/silvercraft_36/3.jpg'
const img4 = '../assets/media/boats/silvercraft_36/4.jpg'
...
const Page = ({location, data}) => {
  return (
    <Layout>
      <Seo
        title={'SilverCraft 36ft - fishing boat'}
